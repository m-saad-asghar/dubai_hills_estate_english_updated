...
const token = window.grecaptcha.getResponse(window.recaptchaWidgetId1);
  ...
  try {
   ...
   setDisableBtn(false);
    ...
    if (result.result) {
      ...
      window.grecaptcha.reset(window.recaptchaWidgetId1);
      await sendLeadEmail();
    } else {
      setDisableBtn(false);
      toast.error(
                                            ...
                                            <div className="row">
                                               <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                    <div className='captcha_container'>
                                                      <div id="recaptcha-contact1" className="g-recaptcha" data-sitekey={process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY}></div>
                                                    </div>
